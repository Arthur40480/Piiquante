...
const normalizePort = val => {
    /**La fonction parseInt() analyse une chaîne de caractère fournie 
     * en argument et renvoie un entier exprimé dans une base donnée.*/
...
const errorHandler = error => {
    ...
    const bind = typeof address === 'string' ? 'pipe ' + port;
    switch (error.code) {
        case 'EACCES':
 ...
 * manière appropriée, elle est ensuite enregistrer dans le serveur.
 */
